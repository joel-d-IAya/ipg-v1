...
const TITLES: Record<Language, string> = {
  fr: 'Magic Image Generator',
  en: 'Magic Image Generator',
  es: 'Magic Image Generator'
};
        ...
        <div className="bg-brand-mid-blue/50 rounded-full p-1 flex items-center">
          {LANGUAGES.map(lang => (
            <button
              ...
              className={`px-3 py-1 text-sm font-medium rounded-full transition-colors duration-300 focus:outline-none ${language === lang.value
